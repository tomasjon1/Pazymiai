...
Versijoje [v0.2] Jums reikia įsijungti terminal. Su komanda cd nueiti iki savo v0.2.cpp failo ir įrašyti "g++ -o main v0.2.cpp" komandą ir kai programa bus sukompiliuota, įrašyti "main.cpp" arba "./main".
